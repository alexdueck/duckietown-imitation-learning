...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="CSV destination; defaults to evaluations/il_gym_duckietown/<timestamp>_returns.csv.",
    )
    parser.add_argument(
        "--screenshot-path",
        type=Path,
        default=Path("gym_duckietown_il_eval.png"),
    )
    parser.add_argument(
        "--log-level",
        default="WARNING",
...
def default_returns_path() -> Path:
    ...
    return Path("evaluations/il_gym_duckietown") / f"{timestamp}_returns.csv"
